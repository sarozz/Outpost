  ...
  return (
    <section id="services" className="border-b border-line/60">
      <div className="mx-auto max-w-page px-6 py-16 md:px-10 md:py-24">
        ...
        <h2 className="max-w-[24ch] font-serif text-[32px] leading-[1.1] tracking-[-0.01em] text-ink md:text-[44px]">
        ...
        <div className="mt-12 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
          ...
          <article className="flex flex-col justify-between rounded-xl bg-coal p-6 text-cream-50">
            <div>
            ...
            <a
              href="#catalogue"
              className="mt-6 inline-flex items-center gap-2 text-[13px] font-medium text-cream-50 underline underline-offset-[6px] decoration-1"
            >
