  ...
  return (
    <section id="trust" className="border-b border-line/60">
      <div className="mx-auto max-w-page px-6 py-16 md:px-10 md:py-24">
        ...
        <div className="mt-10 overflow-hidden rounded-xl border border-line bg-cream-50">
          <dl className="grid grid-cols-1 divide-y divide-line sm:grid-cols-2 sm:divide-y-0 sm:divide-x md:grid-cols-4">
            {rows.map((r) => (
